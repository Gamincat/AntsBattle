...
namespace GamincatKit.Native
{
    public static class NativeUtils
    {
...
#else
        private static readonly NativeUtilsPlugin plugin = new NativeUtilsPlugin_Stub();
#endif
        ...
        public static void OpenReviewDialog(string iosAppID, string title, string message, string okButton = "OK",
        ...
        public static void HapticFeedback(FeedbackType type)
        {
    ...
    public interface NativeUtilsPlugin
    {
        ...
        void OpenReviewDialog(string appId, string title, string message, string okButton = "OK",
            string cancelButton = "Cancel", Action<bool> callback = null);
